...
Es una aplicacion hibrida desarrollada para las plataformas:
...
es importante nombrarlo con el mismo nombre por el cual esta definido en el archivo .env o visebersa asi como se esta nombrando en el archivo .env asi nombrar la base de datos del proyectoAPI
...
instalar las dependendias del backend, entrar a la carpeta proyectoAPI 
ejecutar el comando:
composer install
